...
class Equation:
    ...
    def split_symbols(self):
        ...
        for item in items_old:
            ...
            pos = 0
            while pos < len(string):
                if (pos + 1 < len(string)) and issymbol(
                        string[pos:pos + 2], self.symbols):
    ...
    def calculate_mass(self):
        ...
        for item in self.items:
            ...
            sum += this
            print('{0:<3}'.format(better_looking_symbol(item[0])),
                  '{0:<10}'.format(getname(item[0], self.name)), '\t',
                  getmass(item[0], self.mass), 'g/mol\t * ', item[1], '\t = ',
                  this, '\taccumulate:', sum)
        print(
            "=================================================================="
        )
